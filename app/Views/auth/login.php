                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('/') ?>" class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="input" type="text" class="form-control" name="input" tabindex="1" required autofocus value="<?= old('input') ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-secondary btn-lg btn-block" href="<?= base_url('daftar') ?>">Daftar</a>
                                    </div>
                                </form>
                            </div>
                        </div>
